...
ThemeData light = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF0052CC))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF0052CC), secondary: Color(0xFFFF7A00)).copyWith(error: const Color(0xFFE84D4F)),

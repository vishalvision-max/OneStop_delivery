        ...
        children: [
          ...
          Row(
            ...
            children: [
              Row(children: [
                ...
                Text('my_wallet'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ]),
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    Text('view_all'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
          ...
          Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF0052CC).withValues(alpha: isDark ? 0.15 : 0.35),
                    ...
                    children: [
                      ...
                      model != null
                          ? Text(
                              ...
                              style: robotoBold.copyWith(fontSize: 32, color: Colors.white),
                      ...
                      Row(
                        children: [
                          _WalletStatItem(
                            ...
                            value: model != null ? PriceConverterHelper.convertPrice(totalEarned) : null,
                          ...
                          _WalletStatItem(
                            ...
                            value: model != null ? PriceConverterHelper.convertPrice(pending) : null,
                      ...
                      if (hasEarnings) ...[
                        ...
                        Row(
                          children: [
                            _EarningStatItem(label: 'today'.tr, amount: todayEarning),
                            Container(width: 1, height: 34, color: Colors.white.withValues(alpha: 0.15)),
                            _EarningStatItem(label: 'this_week'.tr, amount: weekEarning),
                            Container(width: 1, height: 34, color: Colors.white.withValues(alpha: 0.15)),
                            _EarningStatItem(label: 'this_month'.tr, amount: monthEarning),
                          ],
                        ),
                      ],
                    ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    label,
                    style: robotoRegular.copyWith(fontSize: 10, color: Colors.white.withValues(alpha: 0.7)),
                    maxLines: 1, overflow: TextOverflow.ellipsis,
                  ),
    ...
    return Expanded(
      child: Column(
        children: [
          Text(
            label,
            style: robotoMedium.copyWith(fontSize: 10, color: Colors.white.withValues(alpha: 0.75)),
          ),
          ...
          amount != null
              ...
              : Shimmer(
                  duration: const Duration(seconds: 2),
                  color: Colors.white.withValues(alpha: 0.3),
                  child: Container(height: 14, width: 40, color: Colors.white.withValues(alpha: 0.2)),
                ),
        ],
      ),
    );
